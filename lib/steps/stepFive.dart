...
class StepFivePage extends StatefulWidget {
  ...
  final Map steps;
  final int idx = 0;
  StepFivePage({Map steps, int idx}) : this.steps = steps;

  @override
  _StepPageState createState() => _StepPageState(steps);
}

class _StepPageState extends State<StepFivePage> {
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              child: Text(
                "Not a weasel but awfully close; he is begging for a drink but his spelling needs improving.",
                maxLines: null,
                textScaleFactor: 1.5,
